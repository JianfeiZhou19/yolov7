...
On video:
``` shell
python detect.py --weights weights/best.py --source yourvideo.mp4
```

On image:
``` shell
python detect.py --weights weights/best.pt --source inference/images/qdtg_bof1_0301_image0002.jpg
```
